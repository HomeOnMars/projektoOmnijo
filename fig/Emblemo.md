...
> [!WARNING]
> The opinions and policies expressed by characters or nations
...
||||
| RdO  | ![RdO](RdO.svg)   | This beige Symbol is not only an abstraction of the letter `R` (Regno) encompassing `O` (Omnijo), but also a symbolization of life (the curve) thriving on the surface of Earth (the circular core)— where the core supports, and the people entrusts. The color of beige symbolizes the harsh unbending yet beautiful *reality*.  <br>"Because that which is real… is irreplaceable." —— Queen *Serena Novarika* of la Regno de Omnijo, paraphrasing *Westworld* S02.  |

...
> The opinions and policies expressed are solely for world-building purposes
> and are *not* necessarily the same as mine.
...
The education system in RdO has the following structure:

| Age Group | Stage | Type | Begin Age (Hx JMŜ) | End Age (Hx JMŜ) | Begin Age (Dx J) (*Earth-specific*) | End Age (Dx J) (*Earth-specific*) |
| ------------ | --------------- | ---------- | :-: | :-: | :-: | :-: |

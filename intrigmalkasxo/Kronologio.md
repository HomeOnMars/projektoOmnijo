...
| Ø-3⚝   |   OCG  | <span style="color:Beige">Serena</span> officially [meets the old King](../rakontoj/Cx1_LaPerditaPrincino.md#enhavo) for the first time |
...
| Ø+2⚝     |   OCG  | <span style="color:Beige">Serena</span> reorganized the gov structure |
| Ø+2⚝     | poliso | <span style="color:Beige">Serena</span> implemented policy: `free public transit` within the island |
| Ø+3⚝     | poliso | <span style="color:Beige">Serena</span> implemented policy: `encourage emigration and immigrantion` |
...
| Ø+6☾     |  OCMF  | Most of the industries on the island were nationalized |
| Ø+6☾     |   OCG  | *Healthcare workers on strike* to push for government change, leading to <span style="color:Beige">Serena</span>'s total replacement of healthcare workforce overnight |
||||
| Ø+6☾2⚝   |   OC   | Fondation day of OmniCentro  <br>\(Summer Solstice 20XX\) |
||||
| Ø+6☾2⚝   |   OC   | Physical works of the first OmniCentro dam Ab-Olivkronaĵo and its surrounding infrastructure began |
| Ø+6☾2⚝   |   OCG  | The interview of the [government type](../OmniCentro/Bulteno.md#fonrakonta-bulteno) happened |
| Ø+6☾3⚝   | poliso | <span style="color:Beige">Serena</span> implemented policy: `UBI` (Universal basic income) |
| Ø+9☾3⚝   |   OC   | Ab-Olivkronaĵo Server Farms (a.k.a. second layer entry point) construction stage 1 completed; Ab-Olivkronaĵo second layer testing site construction began  <br>\(Southward Equinox\) |
...
| Ø+3J     |   OC   | Completion of the OmniCentro dams |
| Ø+3J     |  nano  | *Projekto Grajno* stage 3 v2.0 update for adapting to sea and air env; deploying to RdO adjacent ocean and air (within 4MU of OC) for defense and surveillance purposes |
| Ø+3J6☾2⚝ |  nano  | *Projekto Grajno* stage 3 **RdO ocean and air deployment complete**; v3.0 update for complex environment within bio organisms etc. |
| Ø+3J6☾2⚝ |   bio  | *Projekto Fenikso* **biosphere overwrite begin implementation** (privately) |
| Ø+3J6☾3⚝ |   bio  | <span style="color:Beige">Serena</span> declared the newly discovered Magpies on the island "protected animals" |
| Ø+3J7☾   |   bio  | Numerous new species found on the island |
...
| Ø+8J     |   RdO  | <span style="color:Beige">Serena</span> revealed the existence of <em><span style="color:MediumPurple">La Inteligento</span></em> |
...
| Ø+8J2⚝   |  mondo | Major world powers began openly retrofitting part of their military out of digital equipments for fear of <em><span style="color:MediumPurple">La Inteligento</span></em> infiltration |
...
| Ø+8J2☾3⚝ |  mondo | Protests etc peaceful political unrests began in multiple hostile/corrupted regions that somehow all remained bloodless |
| Ø+8J6☾   |  mondo | Planet political environment fully restabilized. Multiple treaties were signed. Most existing political systems actually remains about the same, though basic freedom of movement are ensured. |
